          ...
          {successMessage && (
            <div className="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
              ...
              <div className="mt-2 mb-4 text-sm">
                <p>Total Price: Rp {parseInt(successMessage.total).toLocaleString()}</p>
                <p>Paid: Rp {parseInt(successMessage.amount).toLocaleString()}</p>
                <p>Change: Rp {parseInt(successMessage.change).toLocaleString()}</p>
              </div>
              <div className="flex">
                <button
                  type="button"
